...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=28 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=2 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=28 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  altfp_convert0_altbarrel_shift_puf
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[27:0]	sbit_piper1d;
	reg	[27:0]	sbit_piper2d;
	reg	sel_pipec3r1d;
	reg	sel_pipec4r1d;
	wire  [5:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 28'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[83:56];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 28'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[139:112];
	// synopsys translate_off
	initial
		sel_pipec3r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		direction_w = 1'b0,
		pad_w = {16{1'b0}},
		result = sbit_w[167:140],
		sbit_w = {sbit_piper2d, smux_w[111:84], sbit_piper1d, smux_w[55:0], data},
		sel_w = {sel_pipec4r1d, sel_pipec3r1d, distance[2:0]},
		smux_w = {((({28{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[123:112], pad_w[15:0]}) | ({28{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[139:128]})) | ({28{(~ sel_w[4])}} & sbit_w[139:112])), ((({28{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[103:84], pad_w[7:0]}) | ({28{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[111:92]})) | ({28{(~ sel_w[3])}} & sbit_w[111:84])), ((({28{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[79:56], pad_w[3:0]}) | ({28{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[83:60]})) | ({28{(~ sel_w[2])}} & sbit_w[83:56])), ((({28{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[53:28], pad_w[1:0]}) | ({28{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[55:30]})) | ({28{(~ sel_w[1])}} & sbit_w[55:28])), ((({28{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[26:0], pad_w[0]}) | ({28{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[27:1]})) | ({28{(~ sel_w[0])}} & sbit_w[27:0]))};
endmodule //altfp_convert0_altbarrel_shift_puf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //altfp_convert0_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	altfp_convert0_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	altfp_convert0_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[3:2]),
...
endmodule //altfp_convert0_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	altfp_convert0_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	altfp_convert0_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //altfp_convert0_altpriority_encoder_be8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //altfp_convert0_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	altfp_convert0_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	altfp_convert0_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //altfp_convert0_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	altfp_convert0_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	altfp_convert0_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //altfp_convert0_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	altfp_convert0_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	altfp_convert0_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //altfp_convert0_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	altfp_convert0_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	altfp_convert0_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //altfp_convert0_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	altfp_convert0_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	altfp_convert0_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //altfp_convert0_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 5 lpm_compare 1 reg 231 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altfp_convert_fpn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [27:0]   wire_altbarrel_shift3_result;
	...
	reg	[26:0]	mag_int_a_reg;
	reg	[26:0]	mag_int_a_reg2;
	...
	reg	sign_int_a_reg4;
	reg	sign_int_a_reg5;
	wire  [26:0]   wire_add_sub1_result;
	...
	wire  [27:0]  prio_mag_int_a;
	wire  [3:0]  priority_pad_one_w;
	wire  [31:0]  result_w;
	wire  round_bit_w;
	wire  [26:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [1:0]  sticky_bit_bus;
	wire  [1:0]  sticky_bit_or_w;
	wire  sticky_bit_w;
	wire  [2:0]  zero_padding_w;

	altfp_convert0_altbarrel_shift_puf   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_convert0_altpriority_encoder_qb6   altpriority_encoder2
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 27'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 27'b0;
	...
	.cout(),
	.dataa(invert_int_a),
	.datab(27'b000000000000000000000000001),
	.overflow(),
	...
	assign
		...
		guard_bit_w = shifted_mag_int_a[3],
		int_a = dataa[26:0],
		int_a_2s = wire_add_sub1_result,
		invert_int_a = (~ int_a),
		leading_zeroes = (~ priority_encoder_reg),
		mag_int_a = (({27{(~ sign_int_a)}} & int_a) | ({27{sign_int_a}} & int_a_2s)),
		...
		mantissa_pre_round = shifted_mag_int_a[26:3],
		...
		priority_pad_one_w = {4{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		round_bit_w = shifted_mag_int_a[2],
		shifted_mag_int_a = wire_altbarrel_shift3_result[26:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[27],
		sticky_bit_bus = shifted_mag_int_a[1:0],
		sticky_bit_or_w = {(sticky_bit_or_w[0] | sticky_bit_bus[1]), sticky_bit_bus[0]},
		sticky_bit_w = sticky_bit_or_w[1],
		zero_padding_w = {3{1'b0}};
endmodule //altfp_convert0_altfp_convert_fpn
//VALID FILE
...
module altfp_convert0 (
	...
	altfp_convert0_altfp_convert_fpn	altfp_convert0_altfp_convert_fpn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: CONSTANT: WIDTH_DATA NUMERIC "28"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_convert0.v TRUE FALSE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_convert0_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_convert0_bb.v TRUE TRUE
