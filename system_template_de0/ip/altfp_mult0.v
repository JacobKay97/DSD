...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone III" EXCEPTION_HANDLING="NO" PIPELINE=6 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
module  altfp_mult0_altfp_mult_1fo
	( 
	clk_en,
	clock,
	dataa,
...
endmodule //altfp_mult0_altfp_mult_1fo
//VALID FILE
...
module altfp_mult0 (
	...
	altfp_mult0_altfp_mult_1fo	altfp_mult0_altfp_mult_1fo_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
