...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=24 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=2 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altfp_convert_v4n
	( 
	clock,
	dataa,
	result) ;
...
endmodule //altfp_convert0_altfp_convert_v4n
//VALID FILE
...
module altfp_convert0 (
	...
	altfp_convert0_altfp_convert_v4n	altfp_convert0_altfp_convert_v4n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
