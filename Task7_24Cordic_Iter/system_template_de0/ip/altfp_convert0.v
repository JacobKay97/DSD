...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=24 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=2 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=24 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  altfp_convert0_altbarrel_shift_luf
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[23:0]	sbit_piper1d;
	reg	[23:0]	sbit_piper2d;
	reg	sel_pipec3r1d;
	reg	sel_pipec4r1d;
	wire  [5:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 24'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[71:48];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 24'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[119:96];
	// synopsys translate_off
	initial
		sel_pipec3r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		direction_w = 1'b0,
		pad_w = {16{1'b0}},
		result = sbit_w[143:120],
		sbit_w = {sbit_piper2d, smux_w[95:72], sbit_piper1d, smux_w[47:0], data},
		sel_w = {sel_pipec4r1d, sel_pipec3r1d, distance[2:0]},
		smux_w = {((({24{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[103:96], pad_w[15:0]}) | ({24{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[119:112]})) | ({24{(~ sel_w[4])}} & sbit_w[119:96])), ((({24{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[87:72], pad_w[7:0]}) | ({24{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[95:80]})) | ({24{(~ sel_w[3])}} & sbit_w[95:72])), ((({24{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[67:48], pad_w[3:0]}) | ({24{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[71:52]})) | ({24{(~ sel_w[2])}} & sbit_w[71:48])), ((({24{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[45:24], pad_w[1:0]}) | ({24{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[47:26]})) | ({24{(~ sel_w[1])}} & sbit_w[47:24])), ((({24{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[22:0], pad_w[0]}) | ({24{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[23:1]})) | ({24{(~ sel_w[0])}} & sbit_w[23:0]))};
endmodule //altfp_convert0_altbarrel_shift_luf
...
module  altfp_convert0_altpriority_encoder_6v7
	...
	altfp_convert0_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	altfp_convert0_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
module  altfp_convert0_altpriority_encoder_6e8
	...
	altfp_convert0_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
...
module  altfp_convert0_altpriority_encoder_bv7
	...
	altfp_convert0_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	altfp_convert0_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
module  altfp_convert0_altpriority_encoder_be8
	...
	altfp_convert0_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	altfp_convert0_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
module  altfp_convert0_altpriority_encoder_r08
	...
	altfp_convert0_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	altfp_convert0_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
module  altfp_convert0_altpriority_encoder_rf8
	...
	altfp_convert0_altpriority_encoder_be8   altpriority_encoder16
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	altfp_convert0_altpriority_encoder_be8   altpriority_encoder17
	( 
	.data(data[15:8]),
...
module  altfp_convert0_altpriority_encoder_qb6
	...
	altfp_convert0_altpriority_encoder_r08   altpriority_encoder4
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder4_q));
	altfp_convert0_altpriority_encoder_rf8   altpriority_encoder5
	( 
	.data(data[31:16]),
...
//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 188 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_convert0_altfp_convert_bpn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [23:0]   wire_altbarrel_shift3_result;
	...
	reg	[22:0]	mag_int_a_reg;
	reg	[22:0]	mag_int_a_reg2;
	...
	reg	sign_int_a_reg4;
	reg	sign_int_a_reg5;
	wire  [22:0]   wire_add_sub1_result;
	...
	wire  [23:0]  prio_mag_int_a;
	wire  [7:0]  priority_pad_one_w;
	wire  [31:0]  result_w;
	wire  [22:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [2:0]  zero_padding_w;

	altfp_convert0_altbarrel_shift_luf   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 23'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 23'b0;
	...
	assign
		...
		mag_int_a = (({23{(~ sign_int_a)}} & int_a) | ({23{sign_int_a}} & int_a_2s)),
		mantissa_bus = mantissa_rounded[22:0],
		mantissa_pre_round = {shifted_mag_int_a[22:0], 1'b0},
		...
		priority_pad_one_w = {8{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift3_result[22:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[23],
		zero_padding_w = {3{1'b0}};
endmodule //altfp_convert0_altfp_convert_bpn
//VALID FILE
...
module altfp_convert0 (
	...
	altfp_convert0_altfp_convert_bpn	altfp_convert0_altfp_convert_bpn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
